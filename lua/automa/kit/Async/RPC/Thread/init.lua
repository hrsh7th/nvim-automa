...
local Session = require('automa.kit.Async.RPC.Session')

---@class automa.kit.Async.RPC.Thread
---@field private thread uv.luv_thread_t
---@field private session automa.kit.Async.RPC.Session
local Thread = {}
Thread.__index = Thread

---Create new thread.
---@param dispatcher_ fun(session: automa.kit.Async.RPC.Session)
