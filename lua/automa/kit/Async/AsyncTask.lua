...
---@class automa.kit.Async.AsyncTask
---@field private value any
---@field private status automa.kit.Async.AsyncTask.Status
...
---@param status automa.kit.Async.AsyncTask.Status
---@param value any
...
---@enum automa.kit.Async.AsyncTask.Status
AsyncTask.Status = {
  Pending = 0,
  Fulfilled = 1,
  Rejected = 2,
...
---@return { status: automa.kit.Async.AsyncTask.Status, value: any }
