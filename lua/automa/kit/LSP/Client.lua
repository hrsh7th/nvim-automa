...
---@param params automa.kit.LSP.ConfigurationParams
...
---@param params automa.kit.LSP.InlineCompletionParams
...
---@param params automa.kit.LSP.DocumentRangesFormattingParams
