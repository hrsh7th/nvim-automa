...
---@param encoding? automa.kit.LSP.PositionEncodingKind
...
---@param bufnr integer
---@param position automa.kit.LSP.Position
---@param from_encoding? automa.kit.LSP.PositionEncodingKind
...
---@param position automa.kit.LSP.Position
---@param from_encoding? automa.kit.LSP.PositionEncodingKind
---@return automa.kit.LSP.Position
...
---@param position automa.kit.LSP.Position
---@param from_encoding automa.kit.LSP.PositionEncodingKind
---@param to_encoding automa.kit.LSP.PositionEncodingKind
