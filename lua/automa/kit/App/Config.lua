...
local Cache = require('automa.kit.App.Cache')

---@class automa.kit.App.Config.Schema

---@alias automa.kit.App.Config.SchemaInternal automa.kit.App.Config.Schema|{ revision: integer }

---@class automa.kit.App.Config
---@field private _cache automa.kit.App.Cache
---@field private _default automa.kit.App.Config.SchemaInternal
---@field private _global automa.kit.App.Config.SchemaInternal
---@field private _filetype table<string, automa.kit.App.Config.SchemaInternal>
---@field private _buffer table<integer, automa.kit.App.Config.SchemaInternal>
local Config = {}
Config.__index = Config

---Create new config instance.
---@param default automa.kit.App.Config.Schema
...
---@param config automa.kit.App.Config.Schema
...
---@return automa.kit.App.Config.Schema
function Config:get()
...
---@return fun(config: automa.kit.App.Config.Schema)|{ filetype: fun(filetypes: string|string[], config: automa.kit.App.Config.Schema), buffer: fun(bufnr: integer, config: automa.kit.App.Config.Schema) }
